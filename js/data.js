...
const AppData = {
    ...
    vocabulary: {
        greetings: {
            ...
            words: [
                // Niveau 1 - Basis
                { it: "Ciao", nl: "Hallo / Dag", note: "Informeel, voor vrienden", level: 1 },
                { it: "Sì", nl: "Ja", note: "", level: 1 },
                { it: "No", nl: "Nee", note: "", level: 1 },
                { it: "Grazie", nl: "Bedankt", note: "", level: 1 },
                { it: "Prego", nl: "Alstublieft / Graag gedaan", note: "Meerdere betekenissen", level: 1 },
                // Niveau 2 - Eenvoudig
                { it: "Buongiorno", nl: "Goedemorgen / Goedendag", note: "Formeel, tot 's middags", level: 2 },
                { it: "Buonasera", nl: "Goedenavond", note: "Vanaf late namiddag", level: 2 },
                { it: "Buonanotte", nl: "Goedenacht", note: "Bij het slapengaan", level: 2 },
                { it: "Arrivederci", nl: "Tot ziens", note: "Formeel afscheid", level: 2 },
                { it: "A presto", nl: "Tot snel", note: "Informeel", level: 2 },
                // Niveau 3 - Gemiddeld
                { it: "Come stai?", nl: "Hoe gaat het? (informeel)", note: "Tegen vrienden/familie", level: 3 },
                { it: "Come sta?", nl: "Hoe gaat het? (formeel)", note: "Tegen onbekenden/ouderen", level: 3 },
                { it: "Bene, grazie", nl: "Goed, bedankt", note: "Standaard antwoord", level: 3 },
                { it: "Piacere", nl: "Aangenaam", note: "Bij kennismaking", level: 3 },
                { it: "Scusa", nl: "Sorry (informeel)", note: "", level: 3 },
        ...
        food: {
            ...
            words: [
                // Niveau 1 - Basis
                { it: "il pane", nl: "het brood", note: "Mannelijk woord", level: 1 },
                { it: "l'acqua", nl: "het water", note: "Vrouwelijk, l' voor klinker", level: 1 },
                { it: "il latte", nl: "de melk", note: "Mannelijk woord", level: 1 },
                { it: "la pizza", nl: "de pizza", note: "Vrouwelijk woord", level: 1 },
                { it: "la pasta", nl: "de pasta", note: "Vrouwelijk woord", level: 1 },
                // Niveau 2 - Eenvoudig
                { it: "il vino", nl: "de wijn", note: "Mannelijk woord", level: 2 },
                { it: "la birra", nl: "het bier", note: "Vrouwelijk woord", level: 2 },
                { it: "il caffè", nl: "de koffie", note: "Mannelijk, accent op laatste lettergreep", level: 2 },
                { it: "il tè", nl: "de thee", note: "Mannelijk woord", level: 2 },
                { it: "il formaggio", nl: "de kaas", note: "Mannelijk woord", level: 2 },
                { it: "il gelato", nl: "het ijs", note: "Mannelijk woord", level: 2 },
                { it: "la frutta", nl: "het fruit", note: "Vrouwelijk woord", level: 2 },
                // Niveau 3 - Gemiddeld
        ...
        family: {
            ...
            words: [
                // Niveau 1 - Basis
                { it: "la mamma", nl: "de mama", note: "Vrouwelijk, informeel", level: 1 },
                { it: "il papà", nl: "de papa", note: "Mannelijk, informeel", level: 1 },
                { it: "la famiglia", nl: "de familie", note: "Vrouwelijk woord", level: 1 },
                // Niveau 2 - Eenvoudig
                { it: "il padre", nl: "de vader", note: "Mannelijk woord", level: 2 },
                { it: "la madre", nl: "de moeder", note: "Vrouwelijk woord", level: 2 },
                { it: "il figlio", nl: "de zoon", note: "Mannelijk woord", level: 2 },
                { it: "la figlia", nl: "de dochter", note: "Vrouwelijk woord", level: 2 },
                { it: "il fratello", nl: "de broer", note: "Mannelijk woord", level: 2 },
                { it: "la sorella", nl: "de zus", note: "Vrouwelijk woord", level: 2 },
                // Niveau 3 - Gemiddeld
        ...
        travel: {
            ...
            words: [
                // Niveau 1 - Basis
                { it: "il treno", nl: "de trein", note: "Mannelijk woord", level: 1 },
                { it: "l'autobus", nl: "de bus", note: "Mannelijk, l' voor klinker", level: 1 },
                { it: "la macchina", nl: "de auto", note: "Vrouwelijk woord", level: 1 },
                { it: "l'aereo", nl: "het vliegtuig", note: "Mannelijk woord", level: 1 },
                // Niveau 2 - Eenvoudig
                { it: "il viaggio", nl: "de reis", note: "Mannelijk woord", level: 2 },
                { it: "l'aeroporto", nl: "de luchthaven", note: "Mannelijk, l' voor klinker", level: 2 },
                { it: "la stazione", nl: "het station", note: "Vrouwelijk woord", level: 2 },
                { it: "il biglietto", nl: "het kaartje", note: "Mannelijk woord", level: 2 },
                { it: "l'albergo", nl: "het hotel", note: "Mannelijk, l' voor klinker", level: 2 },
                { it: "la camera", nl: "de kamer", note: "Vrouwelijk woord", level: 2 },
                // Niveau 3 - Gemiddeld
        ...
        common: {
            ...
            words: [
                ...
                { it: "sì", nl: "ja", note: "", level: 1 },
                { it: "no", nl: "nee", note: "", level: 1 },
                { it: "e", nl: "en", note: "", level: 1 },
                { it: "o", nl: "of", note: "", level: 1 },
                { it: "ma", nl: "maar", note: "", level: 1 },
                // Niveau 2 - Eenvoudig
                { it: "grazie", nl: "bedankt", note: "", level: 2 },
                { it: "prego", nl: "alstublieft / graag gedaan", note: "Meerdere betekenissen", level: 2 },
                { it: "per favore", nl: "alstublieft (bij verzoek)", note: "", level: 2 },
                { it: "scusa", nl: "sorry (informeel)", note: "", level: 2 },
